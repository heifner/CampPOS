...
/**
 * @defgroup bctemplatedata_enum Template Data Types
 * @{
...
/**
 * @defgroup bcimagedata_enum Image Data Types
 * @{
...
/** @brief Constant used in supplemetary structure for values not to be changed
 * 
 */
...
typedef struct
{
    ...
    /** @brief Compliance bits according to ANSI template standard paragraph 6.4.5. Not used, defined for future use.
     */
    uint32 captureEquipmentCompliance;

    /** @brief Identification of equipment assigned by its manufacturer.
     */
...
typedef struct
{
    ...
    /** @brief Compliance bits according to ANSI standard paragraph 6.4.5. Note: Only the lowest 4 bits are used.
     */
    uint32 captureEquipmentCompliance;

    /** @brief Identification of equipment assigned by its manufacturer. Note: Only the lowest 12 bits are used. 
     */
    uint32 captureEquipmentId;
